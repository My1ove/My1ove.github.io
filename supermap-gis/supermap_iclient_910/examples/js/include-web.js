...
(function () {
    ...
    function load() {
        ...
        if (!inArray(excludes, 'example-i18n')) {
            ...
            inputScript("examples/js/utils.js");
            inputScript("examples/js/localization.js");
            document.writeln("<script>Localization.initializeI18N('examples', function () {Localization.localize();Localization.initGlobal();}); </script>");
            jQueryInclude = true;
        }
